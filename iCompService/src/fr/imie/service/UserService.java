...
public class UserService extends ATransactional implements IUserService {
	 ...
	 */
	@Override
	public Utilisateur insertUser(Utilisateur userToInsert) throws TransactionalConnectionException {
		IUtilisateurDAO userDAO = Factory.getInstance().createUserDAO(this);
	 ...
	 */
	@Override
	public void deleteUser(Utilisateur userToDelete) throws TransactionalConnectionException {
		IUtilisateurDAO userDAO = Factory.getInstance().createUserDAO(this);
	...
	@Override
	public Utilisateur findUser(Utilisateur user) throws TransactionalConnectionException {
			IUtilisateurDAO userDAO = Factory.getInstance().createUserDAO(this);
	...
	@Override
	public Cursus findCursusByUser(Utilisateur user) throws TransactionalConnectionException {
		ICursusDAO cursusDAO = Factory.getInstance().createCursusDAO(this);
