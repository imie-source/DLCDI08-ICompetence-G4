...
<link rel="stylesheet" href="css/administration.css" media="all" type="text/css" />
</head>
	...
	<div id="wrapper">
		...
		<div id="projectlist">
			...
			%>
				...
				<%-- Div Delete --%>
				<div class="delete">
					<a href="#"><img src=img/remove.png alt="Delete" title="Delete" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette entrée?'));"/></a>
				</div>
				
				<%-- Div ChangeChief --%>
				<div class="changechief">
					<a href="#"><img src=img/changechief.png alt="Change Project Leader" title="Change Project Leader" /></a>
				</div>
				
				<%-- Div AddUser --%>
				<div class="adduser">
					<a href="#"><img src=img/adduser.png alt="Add user to the project" title="Add user to the project" /></a>
				</div>
