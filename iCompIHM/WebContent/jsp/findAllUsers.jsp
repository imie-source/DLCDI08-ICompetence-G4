		...
		<div id="wrapper">
			...
			<div id="userlist">
				...
				<div class="line">
					...
					<div class="alternativeline">
						...
						<%-- Div Edit --%>
						<div class="edit">
							<a href="./EditUser?login=<%=usr.getLogin()%>"><img
								src=img/edit.png alt="Edit" title="Edit" /></a>
						</div>

						<%-- Div Delete --%>
						<div class="delete">
							<a href="./DeleteUser?login=<%=usr.getLogin()%>"><img
								src=img/remove.png alt="Delete" title="Delete"
			...
			<div id="popup1" class="popup_block">
				...
				<div id="addUserForm">
					...
					<%-- Form --%>
					<form onsubmit="return valider(this)" method="post"
						action="./AddUser">

						<%-- NOM --%>
						<div class="formLibelle">Nom * :</div>
						<div class="formInput">
							<input type="textbox" name="nom" maxlength="50" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="prenom" maxlength="50" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="dateNaissance" value="JJ/MM/AAAA" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="mail" maxlength="50" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="tel" maxlength="10" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="fax" maxlength="10" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="radio" name="disponible" value=1 checked /> Oui <input
								type="radio" name="disponible" value=0 /> Non
						</div>
						<br />
						...
						<div class="formInput">
							<input type="textbox" name="identifiant" maxlength="20" />
						</div>
						<br />
						...
						<div class="formInput">
							<input type="password" name="confirmpassword" maxlength="25" />
						</div>
						<br />
						...
						<div class="formInput">
							<input id="submit" type="submit" name="insertUser"
								value="Ajouter" />
						</div>
						<br />
